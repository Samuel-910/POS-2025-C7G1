...
public class UsuarioDTO {
    ...
    public record UsuarioCrearDto(String user, char[] clave, String rol, String estado) {
        ...
        public int hashCode() {
            int result = user.hashCode();
            result = 31 * result + Arrays.hashCode(clave);  // Calculando el hash del arreglo
        ...
        public String toString() {
            return "UsuarioCrearDto{" +
                   "user='" + user + '\'' +
                   ", clave=" + Arrays.toString(clave) +  // Usamos Arrays.toString() para mostrar el contenido del arreglo
                   ", rol='" + rol + '\'' +
                   ", estado='" + estado + '\'' +
                   '}';
        }
